...
for subgroup in ['asian_females','asian_males','black_females','black_males','indian_females','indian_males','white_females','white_males']:
    ethnic_dir = os.path.join('bfw_cropped',subgroup)
...
embedding_path = 'bfw_cropped/embeddings'
